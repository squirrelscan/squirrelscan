import { describe, afterAll, beforeAll, expect, test } from "bun:test";
...
describe.skipIf(browserSkipReason !== null)(
  `side-by-side suggestion review (needs a browser)${browserSkipReason ? `: skipped, ${browserSkipReason}` : ""}`,
  () => {
