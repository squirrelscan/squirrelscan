...
Run `squirrel` on its own to see every command, grouped, with a quick start. After installing, run [`squirrel setup`](/cli/setup) once: it signs you in, installs the agent skills and sets your defaults.
...
| Command | Description |
|---------|-------------|
| [`setup`](/cli/setup) | Sign in, install the agent skills and pick your defaults |
...
| [`entities`](/cli/entities) | Query the entity map of a stored audit |
