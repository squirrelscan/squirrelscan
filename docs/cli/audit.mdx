...
This site is re-audited every week and each run costs credits. Turn it off: https://app.squirrelscan.com/acme/website/web_1/settings/schedule
```

The line is absent when the site has no schedule, and the cadence it names is the one your plan actually funds.
