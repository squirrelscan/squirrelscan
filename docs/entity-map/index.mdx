...
<CardGroup cols={2}>
  <Card title="Fix identity problems" icon="wrench" href="/entity-map/fixing">
    Every finding, with the exact change in Yoast, Rank Math, Next.js and Astro.
  </Card>
  <Card title="Query the map" icon="terminal" href="/cli/entities">
    `squirrel entities`, its filters, its export formats and its diff.
  </Card>
</CardGroup>
