...
Publishing a report to the dashboard gives you a shareable URL plus issue history for the site. **Publishing is included in the audit base charge, whatever the visibility.** When you're **logged in and online this happens automatically** (as `unlisted`) for every audit:
