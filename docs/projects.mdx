...
All projects are stored under a single root, and each project gets its own
subdirectory with a SQLite database containing all crawl and audit data:

<FileTree>
- **~/.squirrel/projects/** every project lives here
  - example-com/
    - project.db
  - my-app-dev/
    - project.db
