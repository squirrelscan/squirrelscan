...
description: "Hand one line to your coding agent and it installs squirrelscan, wires up MCP, and audits your website."
icon: "bot"
mode: "custom"
---

{/* `mode: custom` hands us the bare slot, so the prose class the default
     shell would have applied has to come from here. */}
<div class="agent-setup-page prose-tang">

<div class="agent-hero">
  <p class="agent-hero-eyebrow">Agent setup</p>
  <h1>Give your agent the keys</h1>
  <p class="agent-hero-sub">
    One line, pasted into any coding agent. It installs the CLI, wires up MCP,
    audits your website, and starts fixing what it finds. You go and do
    something else.
  </p>
...
<div class="agent-facts">
  <div class="agent-fact">
    ...
    <span class="agent-fact-val">267 rules across SEO, performance, security, accessibility, and agent experience.</span>
  </div>
  <div class="agent-fact">
